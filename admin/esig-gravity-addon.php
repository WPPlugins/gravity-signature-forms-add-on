...
if (class_exists("GFForms")) {
    ...
    class GFEsignAddOn extends GFFeedAddOn {
        ...
        public function feed_list_no_item_message() {
            return __('This form does not have any WP E-Signature workflows connected to it.Lets go to', 'esig-gf') . ' <a href="' . add_query_arg(array('fid' => 0)) . '">' . __('create one', 'esig-gf') . '</a>';
        }
        ...
        public function process_feed($feed, $entry, $form) {
            ...
            $result = $this->esig_invite_document($document_id, $signer_email, $signer_name, $form_id, $entry_id, $signing_logic, $display_feed);
        }
        ...
        public function esig_invite_document($old_doc_id, $email, $signer_name, $form_id, $entry_id, $signing_logic, $display_feed = false) {
